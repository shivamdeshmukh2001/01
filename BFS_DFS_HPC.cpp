...
void bfs(TreeNode* root) {
    ...
    q.push(root);
    while (!q.empty()) {
        TreeNode* node = q.front();  // store value in node
        q.pop();
        cout << node->val << " ";
        if (node->left) {
            q.push(node->left);
...
int main() {
    ...
    auto serb=chrono::duration_cast<chrono::microseconds>(end - start).count();
    cout << endl;
    ...
    auto perb=chrono::duration_cast<chrono::microseconds>(end - start).count();
    ...
    auto ser=chrono::duration_cast<chrono::microseconds>(end - start).count();
    ...
    auto per=chrono::duration_cast<chrono::microseconds>(end - start).count();
